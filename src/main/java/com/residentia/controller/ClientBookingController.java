...
public class ClientBookingController {
    ...
    public ResponseEntity<?> createBooking(@PathVariable Long propertyId,
        ...
        try {
            ...
            // Always use authenticated user's info for tenant details (security)
            bookingDTO.setTenantName(user.getName());
            bookingDTO.setTenantEmail(user.getEmail());
            bookingDTO.setTenantPhone(user.getMobileNumber());
